...
pub struct RuntimeLimits {
    ...
    /// Note: QuickJS doesn't have explicit heap sizing, this is ignored
    pub heap_initial_mb: usize,
    /// Maximum heap size in MB (default: 128MB)
    /// Note: QuickJS doesn't have explicit heap limits, this is ignored
    pub heap_max_mb: usize,
    /// Maximum CPU time in milliseconds (default: 50ms, 0 = disabled)
    /// Note: Not yet implemented in QuickJS runtime
